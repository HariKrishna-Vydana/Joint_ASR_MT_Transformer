#! /bin/sh
#
#$ -q long.q@supergpu[123678],long.q@facegpu*,long.q@pc*,long.q@dellgpu*,
#$ -l gpu=1,gpu_ram=12G,ram_free=7G,matylda3=0.5
#$ -l 'h=!pcgpu4'

#$ -o /mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/log/J_Transformer_T5.log
#$ -e /mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/log/J_Transformer_T5.log



PPATH="/mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer"
cd "$PPATH"
export PYTHONUNBUFFERED=TRUE

only_scoring='False'
scoring_path='/mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/ASR_MT_Transv1'
stage=2
#=======================================
...
encoder_dropout_MT=0.1
encoder_layers_MT=6
encoder_dmodel_MT=512
encoder_heads_MT=4
encoder_dinner_MT=1024
encoder_ff_dropout_MT=0.1
pe_max_len_MT=5000


dec_embd_vec_size_MT=512
decoder_dmodel_MT=512 
decoder_heads_MT=4
decoder_dinner_MT=1024
decoder_dropout_MT=0.1
decoder_ff_dropout_MT=0.1
decoder_layers_MT=6
tie_dec_emb_weights_MT=0
warmup_steps=20000
label_smoothing=0.1
...
test_path='/mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/scp_files/val/'

data_dir="$PPATH/ASR_MT_data_files/"
mkdir -pv $data_dir
...
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/ASR_MT_Transv1/Make_training_scps.py \
                                                --data_dir $data_dir \
...
##---------------------------------------------------------------------------------------------
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/Joint_ASR_MT_Training.py \
                                                --data_dir $data_dir \
                                                --gpu $gpu \
                                                --train_path $train_path \
                                                --dev_path $dev_path \
                                                ...
                                                --encoder_dropout_MT $encoder_dropout_MT \
                                                --encoder_layers_MT $encoder_layers_MT \
                                                --encoder_dmodel_MT $encoder_dmodel_MT \
                                                --encoder_heads_MT $encoder_heads_MT \
                                                --encoder_dinner_MT $encoder_dinner_MT \
                                                --encoder_ff_dropout_MT $encoder_ff_dropout_MT \
                                                --pe_max_len_MT $pe_max_len_MT \
                                                --dec_embd_vec_size_MT $dec_embd_vec_size_MT \
                                                --decoder_dmodel_MT $decoder_dmodel_MT \
                                                --decoder_heads_MT $decoder_heads_MT \
                                                --decoder_dinner_MT $decoder_dinner_MT \
                                                --decoder_dropout_MT $decoder_dropout_MT \
                                                --decoder_ff_dropout_MT $decoder_ff_dropout_MT \
                                                --decoder_layers_MT $decoder_layers_MT \
                                                --tie_dec_emb_weights_MT $tie_dec_emb_weights_MT \
...
/mnt/matylda3/vydana/HOW2_EXP/Gen_V1/ATTNCODE/Basic_Attention_V1/utils/queue.pl \
        ...
        python /mnt/matylda3/vydana/HOW2_EXP/Joint_ASR_MT_Transformer/ASR_MT_Decoding.py \
        --gpu $gpu \
        --model_dir $model_dir \
        --Decoding_job_no JOB \
        --beam $beam \
